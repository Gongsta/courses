...
Reinforcement Learning solution of the [OpenAI's Cartpole](https://gym.openai.com/envs/CartPole-v1/).

Cloned from the original repository: [cartpole](https://github.com/gsurma/cartpole). Modified the code to be executed on python3.7, added commented lines and additional functionalities such as saving episodes as videos.

Check out the Medium Article: [Cartpole - Introduction to Reinforcement Learning (DQN - Deep Q-Learning)](https://towardsdatascience.com/cartpole-introduction-to-reinforcement-learning-ed0eb5b58288)
