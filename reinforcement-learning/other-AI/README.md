...
Cloned from the original repository: [cartpole](https://github.com/gsurma/cartpole). Modified the code to be executed on python3.7, added commented lines and additional functionalities.
...
## Repository Author
**Steven Gong** - [**Github**](https://github.com/gsurma) - [**LinkedIn**](https://linkedin.com/in/gong-steven/)
