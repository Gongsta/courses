...
class DQNSolver:
    ...
    # Experience replay is a biologically inspired process that uniformly (to reduce correlation between subsequent actions) samples experiences
    # from the memory and for each entry updates its Q value.
